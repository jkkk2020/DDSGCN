...
class trainer():
    def __init__(self, batch_size, scaler, in_dim, seq_length, num_nodes, nhid, dropout, lrate, wdecay,
                 supports, supports_, H_a, H_b, G0, G1, indices, G0_all, G1_all, H_T_new, lwjl, clip=3, lr_de_rate=0.97):
        self.model = ddstgcn(batch_size, H_a, H_b, G0, G1, indices, G0_all, G1_all, H_T_new,
                             lwjl, num_nodes, dropout, supports=supports, supports_=supports_, in_dim=in_dim,
